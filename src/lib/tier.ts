...
export interface TierSettings {
  ...
  /** Texture taps per sample on angled screens. The hardware maximum is
   *  typically 16, which is far more than these viewing angles need and costs
   *  real frames. */
  anisotropy: number;
...
export const TIER_SETTINGS: Record<Tier, TierSettings> = {
  high:   { dpr: 2,   shadows: "soft",  post: "full", lights: 3, lod: 0, screen: "video", smoothness: 4, envResolution: 128, metalness: 0.45, anisotropy: 8 },
  medium: { dpr: 1.5, shadows: "baked", post: "aa",   lights: 1, lod: 1, screen: "video", smoothness: 2, envResolution: 64,  metalness: 0.3, anisotropy: 4 },
  low:    { dpr: 1,   shadows: "baked", post: "none", lights: 0, lod: 1, screen: "still", smoothness: 1, envResolution: 32,  metalness: 0.12, anisotropy: 2 },
};
